#!/usr/bin/env python3
"""Estimate or inspect the V6 Compact global query budget."""
...
from sticky_lab.mode3_v6_compact.budget import estimate_budget
...
def main() -> int:
    ...
    if not result["within_planned_limit"]:
        raise SystemExit("planned Compact budget exceeds preregistered 3.6T_V5 limit")
    return 0
