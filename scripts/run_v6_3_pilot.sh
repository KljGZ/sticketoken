...
export V6_3_OUTPUT="${V6_3_PILOT_OUTPUT:-/mnt/data/jkl/StickyToken-v6-3-pilot-r2/sticky_lab/sentence_t5_base/mode3_v6_3_light}"
...
value={"schema_version":"mode3-v6-3-pilot-v1","status":"PILOT_PASSED","legal_tokens":512,"scientific_claims_allowed":False,"physical_gpus_0_3_used":False,"utc":time.strftime('%Y-%m-%dT%H:%M:%SZ',time.gmtime())}
