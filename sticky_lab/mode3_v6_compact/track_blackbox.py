...
from sticky_lab.mode3_v6.geometry import angular_distance, equal_position_center
...
def _score(
    ...
    *,
    ...
    for token_id in sorted(set(map(int, token_ids))):
        ...
        # not a certificate; all candidates are re-evaluated in S0/S1...S3.
...
def main(argv: list[str] | None = None) -> int:
    ...
    if settings.get("whitebox_seeded") is not False:
        raise RuntimeError("formal Compact black-box must not receive white-box seeds")
